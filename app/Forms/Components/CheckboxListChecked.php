...
class CheckboxListChecked extends Field
{
    use HasOptions;

    protected string $view = 'forms.components.checkbox-list-checked';
    ...
    protected function setUp(): void
    {
        ...
        $this->afterStateHydrated(static function (CheckboxListChecked $component, $state) {
            if (is_array($state)) {
                return;
            }
    ...
    public function relationship(string|Closure $relationshipName, string|Closure $titleColumnName, ?Closure $callback = null): static
    {
        ...
        $this->options(static function (CheckboxListChecked $component) use ($callback): array {
        ...
        $this->loadStateFromRelationshipsUsing(static function (CheckboxListChecked $component, ?array $state): void {
            $relationship = $component->getRelationship();
        ...
        $this->saveRelationshipsUsing(static function (CheckboxListChecked $component, ?array $state) {
